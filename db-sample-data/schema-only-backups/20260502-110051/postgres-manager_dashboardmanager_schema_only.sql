...
--
-- Name: idx_ai_chat_sessions_user_activity; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_ai_chat_sessions_user_activity ON public.ai_chat_sessions USING btree (user_id, last_activity_at);


--
-- Name: idx_ai_chat_sessions_user_status; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_ai_chat_sessions_user_status ON public.ai_chat_sessions USING btree (user_id, status);
